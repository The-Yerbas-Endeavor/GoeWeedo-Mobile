...
Scanner-only companion app built from the same native repository as the full GeoWeedo app.
...
The scanner target reuses the existing native ML Kit barcode/QR scanner, torch, zoom, scan-from-photo support and camera permission setup.
